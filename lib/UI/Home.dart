            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Center(child: Text(AppLocalizations.of(context).trans("daamCard") , style: AppTextStyle.mediumWhiteBold,)),
                  drawerWidget("aboutUs",onTap:(){
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => AboutUs()));
                  }),

                  dataStore.user==null?drawerWidget("login",onTap: ()async{
...
//                  });
                  ...
                  dataStore.user==null?drawerWidget("signUp",onTap: () async {
                    await Navigator.of(context).push(MaterialPageRoute(
...
//                  });
                  ...
                  dataStore.user!=null&& !dataStore.user.data.isProvider?drawerWidget("myAccount" , onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => UserDetails()
                    ));
                  }):Container(),
                  dataStore.user!=null?drawerWidget("history" , onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => (!dataStore.user.data.isProvider)?UserHistoryPage():ServiceProviderHistory()
                    ));
                  }):Container(),

                  dataStore.user!=null && dataStore.user.data.isProvider?drawerWidget("scanCode" , onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(
                  ...
                  dataStore.user==null ?drawerWidget("serviceProviderLogin",onTap: ()async{
                    await Navigator.of(context).push(MaterialPageRoute(
                        builder: (context)=>SignIn(type: "ServiceProvider",)
                    ));
//                  setState(() {
//
//                  });
                  ...
                  dataStore.user!=null?drawerWidget("logout",onTap: () async {
            ...
            child: Row(
              children: [
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      AppConstant.IMAGE_URL + dataStore.user.data.photo,
                        width: 100,
                        height: 100,
                        fit: BoxFit.fill,
                      ),
                    ...
                    children: [
                      Text(
                        dataStore.user.data.isProvider?
                            dataStore.lang == "ar"?
                        dataStore.user.data.businessName:(dataStore.user.data.businessNameEn??"")
                    ...
                    if(snapshot.hasData || dataStore.user == null)
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            children: [
                              snapshot.hasData && snapshot.data.code == 200?homeCard(name: 'myCard' , onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => UseCard(snapshot.data.data.id.toString(),snapshot.data.data.card)
                                ));
                              }):homeCard(name: 'orderCard' , onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => CardsPage()
                                ));
                              }),
                              homeCard(name: 'placesNearYou', onTap: (){

                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => NearestServiceProvider()
                                ));
                              }),
                            ],
                          ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              homeCard(name: 'markets',onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => NetworksPage()
                                ));
                              }),
                            ],
                          ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              homeCard(name: 'couponsGifts',onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => NetworksPage(type: "coupons",)
                                ));
                              }),
                            ],
                          ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              homeCard(name: 'joinUs',onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => AddServiceProvider()
                                ));
                              }),//AddServiceProvider
                              homeCard(name: 'latestNews',onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              homeCard(name: 'sellCenters' ,onTap: (){
                                 Navigator.of(context).push(MaterialPageRoute(
                                   builder: (context) => SalesCentersPage()
                                 ));
                              }),
                              homeCard(name: 'contactUs',onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context){
                                    return ContactUs();
                                  }
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      homeCard(name: 'scanCode' , onTap: (){

                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => ScanCode()
                        ));
                      }),
                      homeCard(name: 'history', onTap: (){

                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => ServiceProviderHistory()
                        ));
                      }),
                    ],
                  ),
                ...
                child: Container(
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image:AssetImage('assets/images/${name == "myCard"?"orderCard":(name == "scanCode" || name == "history")?"markets":name}.jpg'),
                  ...
                  child: Container(
                      ...
                      child: Text(
                        ...
                        maxLines: 1,
                        style: AppTextStyle.mediumBlackBold.copyWith(color: AppColors.cyan,fontSize: MediaQuery.of(context).size.width <= 300 ?10:14),
                      )),
                ),
              ),
            ),
  ...
  drawerWidget(text ,{Function onTap}){
    return InkWell(
      ...
      child: Padding(
        padding: const EdgeInsets.all(8.0),
        child: Text(AppLocalizations.of(context).trans(text) , style: AppTextStyle.mediumCyanBold,),
      ),
    );
  }
}
